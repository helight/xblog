...
<a href="/zb_users/upload/2018/03/u849181411409596040fm27gp0.jpg"><img src="/zb_users/upload/2018/03/u849181411409596040fm27gp0.jpg" alt="" /></a>
...
<pre><code class="language-proto line-numbers">    service RouteGuide {
...
<pre><code class="language-go line-numbers">type routeGuideClient struct { 
...
<h2>server端关键的几句代码可以看看</h2>

<pre><code class="language-go line-numbers">type routeGuideServer struct {} //定义一个实现体，后面还有具体服务方法的实现
...
...
<pre><code class="language-go line-numbers">conn, err := grpc.Dial(*serverAddr, opts...) // 创建连接
....
