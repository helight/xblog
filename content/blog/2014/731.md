...
<h2>与autoscan生成的文件相比，主要添加修改了以下几行:</h2>
<pre class="code_style">
AC_INIT("myshell", "0.01", "helight.xu@gmail.com")
AM_INIT_AUTOMAKE("myshell", "0.01")
AC_CONFIG_FILES(Makefile
...
<h2>新建立的src/Makefile.am文件的内容</h2>
<pre class="code_style">
...
<h2>再运行:autoconf生成configure文件.</h2>
<pre class="code_style">
...
<h2>再运行autohead 生成config.h.in</h2>
<pre class="code_style">
...
<h2>最后运行automake --add-missing 就能得到Makefile.in</h2>
<pre class="code_style">
